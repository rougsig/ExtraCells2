...
public class UniversalTerminalRecipe extends TemplateRecipeHandler {
    ...
    private class CachedShapelessRecipe extends CachedRecipe {
        ...
        private final PositionedStack result = new PositionedStack(ItemEnum.UNIVERSALTERMINAL.getDamagedStack(0), 119, 24);
        ...
        private void setIngredients() {
            ...
            PositionedStack stack2 = new PositionedStack(UniversalTerminal.terminals(), 43, 6, false);
            stack2.setMaxSize(1);
